...
>Ve al repositorio de Github: , [copia el contenido del archivo y pégalo en un archivo con el mismo nombre en tu instalación](https://github.com/gismodes37/Allmon2-2024/blob/main/allmon.ini.txt" target="_blank").
